  ...
  return (
    <form onSubmit={handleSubmit} className="flex items-end gap-3">
      ...
      <textarea
        ...
        disabled={disabled}
        className={cn(
          "min-h-24 flex-1 resize-none rounded-3xl border border-slate-200 bg-white px-4 py-3 text-sm text-slate-700 outline-none transition placeholder:text-slate-400 focus:border-slate-400",
