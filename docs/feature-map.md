...
| F009 | Home page | TODO | Frontend | Recommended + available doctors |
| F010 | Doctor listing page | TODO | Frontend | Filter sidebar |
| F011 | Booking page | TODO | Frontend | Date/time + patient form |
| F012 | Confirmation page | TODO | Frontend | Appointment details |
| F013 | Basic tests | TODO | Quality | Backend first |
| F014 | Chatbot UI | TODO | Future AI | Later phase |
| F015 | AI command parser | TODO | Future AI | Later phase |
| F016 | Visible browser automation | TODO | Future AI | Later phase |
